...
# aws_vpc.australia-vpc.id
# aws_vpc.california-vpc.id
# aws_vpc.hong-kong-vpc.id
# aws_vpc.london-vpc.id
# aws_vpc.new-york-vpc.id
# aws_vpc.sao-paulo-vpc.id
# aws_vpc.tokyo-test-vpc.id
# aws_vpc.tokyo-vpc.id
